...
Note 3: 
matrix check
arr = cp.arange(704160).reshape(1440, 489)
# yr, mon, districts 
...
B = []
C = []
distances = cp.zeros(shape=(len(dist_id_sel), len(dist_id_sel)))
# min_dist=cp.zeros(shape=(len(dist_id_sel),len(dist_id_sel)))
mdl_c = 0  # set model control index
for mdl in model:
    i = 0  # set item control index
    print(mdl)
    locals()['sp_'+mdl] = cp.array([])
    ...
    for item in ["ppt", "tmax", "tmin"]:
        ...
        locals()[item+'_1895_1950'] = cp.load(prism_1_hist[i])
        # load historical data (PRISM series)
        ...
        locals()[item+'_wt_'+mdl+"_A"] = locals()[item+'_wt_' +
                                                  mdl][yr_total.index("1980"):yr_total.index("2015"), ].mean(axis=0)
        locals()[item+'_'+mdl+"_A_12vs"] = cp.hstack((locals()[item+'_sp_'+mdl+"_A"], locals()
                                                      [item+'_sm_'+mdl+"_A"], locals()[item+'_fl_'+mdl+"_A"], locals()[item+'_wt_'+mdl+"_A"]))
        # locals()['sp_'+mdl]=cp.vstack([locals()['sp_'+mdl], locals()[item+'_sp_'+mdl]]) if locals()['sp_'+mdl].size else locals()[item+'_sp_'+mdl]
        ...
        locals()[item+'_wt_'+mdl+"_B1"] = locals()[item+'_wt_' +
                                                   mdl][yr_total.index("2025"):yr_total.index("2051"), ].mean(axis=0)
        locals()[item+'_'+mdl+"_B1_12vs"] = cp.hstack((locals()[item+'_sp_'+mdl+"_B1"], locals()
        ...
        locals()[item+'_wt_'+mdl+"_B2"] = locals()[item+'_wt_' +
                                                   mdl][yr_total.index("2051"):yr_total.index("2076"), ].mean(axis=0)
        locals()[item+'_'+mdl+"_B2_12vs"] = cp.hstack((locals()[item+'_sp_'+mdl+"_B2"], locals()
        ...
        locals()[item+'_wt_'+mdl+"_B3"] = locals()[item+'_wt_' +
                                                   mdl][yr_total.index("2076"):yr_total.index("2099")+1, ].mean(axis=0)
        locals()[item+'_'+mdl+"_B3_12vs"] = cp.hstack((locals()[item+'_sp_'+mdl+"_B3"], locals()
    ...
    locals()[mdl+"_A_12vs"] = cp.hstack((locals()['ppt_'+mdl+"_A_12vs"],
                                         locals()['tmax_'+mdl+"_A_12vs"], locals()['tmin_'+mdl+"_A_12vs"]))
    # construct 12-variable B matrices (partial)
    locals()[mdl+"_B1_12vs"] = cp.hstack((locals()['ppt_'+mdl+"_B1_12vs"],
                                          locals()['tmax_'+mdl+"_B1_12vs"], locals()['tmin_'+mdl+"_B1_12vs"]))
    locals()[mdl+"_B2_12vs"] = cp.hstack((locals()['ppt_'+mdl+"_B2_12vs"],
                                          locals()['tmax_'+mdl+"_B2_12vs"], locals()['tmin_'+mdl+"_B2_12vs"]))
    locals()[mdl+"_B3_12vs"] = cp.hstack((locals()['ppt_'+mdl+"_B3_12vs"],
    ...
    npp_h = cp.load(mc2_hist[0])
    # npp future: 2015-2099, model-specific
    npp_f = cp.load(locals()["future_n_p_tma_tmi_v_"+mdl][0])
    locals()["npp_"+mdl] = cp.vstack((npp_h, npp_f))
    ...
    locals()[mdl+"_A"] = cp.hstack((locals()['ppt_'+mdl+"_A_12vs"], locals()['tmax_'+mdl+"_A_12vs"],
                                    locals()['tmin_'+mdl+"_A_12vs"], locals()['npp_'+mdl+"_A"])).reshape(13, len(dist_id_sel))
    # finalize B matrices (full, 3 stages respectively)
    locals()[mdl+"_B1"] = cp.hstack((locals()['ppt_'+mdl+"_B1_12vs"], locals()['tmax_'+mdl+"_B1_12vs"],
                                     locals()['tmin_'+mdl+"_B1_12vs"], locals()['npp_'+mdl+"_B1"])).reshape(13, len(dist_id_sel))
    locals()[mdl+"_B2"] = cp.hstack((locals()['ppt_'+mdl+"_B2_12vs"], locals()['tmax_'+mdl+"_B2_12vs"],
                                     locals()['tmin_'+mdl+"_B2_12vs"], locals()['npp_'+mdl+"_B2"])).reshape(13, len(dist_id_sel))
    locals()[mdl+"_B3"] = cp.hstack((locals()['ppt_'+mdl+"_B3_12vs"], locals()['tmax_'+mdl+"_B3_12vs"],
...
# locals()[mdl+"_B1_12vs"]=cp.hstack((locals()[mdl+"_A_12vs"],locals()['tmax_'+mdl+"_B1_12vs"],locals()['tmin_'+mdl+"_B1_12vs"])).reshape(12, len(dist_id_sel))
# locals()[mdl+"_B2_12vs"]=cp.hstack((locals()['ppt_'+mdl+"_B2_12vs"],locals()['tmax_'+mdl+"_B2_12vs"],locals()['tmin_'+mdl+"_B2_12vs"])).reshape(12, len(dist_id_sel))
# locals()[mdl+"_B3_12vs"]=cp.hstack((locals()['ppt_'+mdl+"_B3_12vs"],locals()['tmax_'+mdl+"_B3_12vs"],locals()['tmin_'+mdl+"_B3_12vs"])).reshape(12, len(dist_id_sel))
ending_clock = datetime.now()
# 0:41:48.368475 (R5-3550H nVidia GTX 1050) # 0:48:11.083443 (i7-6700k nVidia K620)
print(ending_clock-starting_clock)
